...
<!--[if IE 6]>
<link rel="stylesheet" type="text/css" href="<c:url value='/css/iecss.css'" />
<![endif]-->
    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        <div class="center_prod_box_big">
          <div class="product_img_big"> <a href="javascript:popImage('img/big_pic.jpg','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="img/p3.jpg" alt="" border="0" /></a>
            <div class="thumbs"> <a href="http://all-free-download.com/free-website-templates/" title="header=[Thumb1] body=[&nbsp;] fade=[on]"><img src="img/thumb1.jpg" alt="" border="0" /></a> <a href="http://all-free-download.com/free-website-templates/" title="header=[Thumb2] body=[&nbsp;] fade=[on]"><img src="img/thumb2.jpg" alt="" border="0" /></a> <a href="http://all-free-download.com/free-website-templates/" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="img/thumb1.jpg" alt="" border="0" /></a> </div>
          </div>
          <div class="details_big_box">
            ...
            <a href="http://all-free-download.com/free-website-templates/" class="prod_buy">add to cart</a> <a href="http://all-free-download.com/free-website-templates/" class="prod_compare">compare</a> </div>
        </div>
      </div>
    </div>
